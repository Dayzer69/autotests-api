...
from clients.files.files_schema import CreateFileRequestSchema, CreateFileResponseSchema, GetFilesResponseSchema
...
class TestFiles:
    ...
    def test_get_file(self, files_client: FilesClient, function_file: FileFixture):
        ...
        response_data = GetFilesResponseSchema.model_validate_json(response.text)
    ...
    def test_get_file_with_incorrect_file_id(self, files_client: FilesClient):
        ...
        response = files_client.get_file_api('fake.request.id')
        response_data = ValidationErrorResponseSchema.model_validate_json(response.text)
